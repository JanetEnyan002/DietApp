...
import { lunchRecipes, Recipe } from '../../data/mealData';
import AsyncStorage from '@react-native-async-storage/async-storage';

type LunchScreenNavigationProp = StackNavigationProp<RootStackParamList, 'LunchRecipes'>;
...
export default function LunchScreen({ navigation }: Props) {
